...
CREATE TABLE `account_images` (
  ...
  `currentPic` tinyint DEFAULT '0',
  PRIMARY KEY (`picID`),
  KEY `FK_PICID_ACCID_idx` (`accountID`),
  CONSTRAINT `FK_PICID_ACCID` FOREIGN KEY (`accountID`) REFERENCES `account` (`accountID`)
...
-- Dump completed on 2022-05-31  1:44:20
